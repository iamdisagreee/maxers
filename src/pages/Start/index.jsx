...
export default function Start({ storageReady, profile, token, onAuthSet}) {
...
const handleProceed = async () => {
  ...
  const isButtonDisabled = !selectedRole || !city || !url || !profile;
    ...
    <div className="startpage-wrapper">
      ...
      <div className="start-cards-wrapper">
        ...
        <div
          role="button"
          tabIndex={0}
          aria-pressed={selectedRole === 'Needy'}
          onClick={() => chooseRole('Needy')}
          className={`start-card ${selectedRole === 'Needy' ? 'start-card-chosen' : 'gradient-primary-bg'}`}
        >
        ...
        <div
          ...
          className={`start-card ${selectedRole === 'Helper' ? 'start-card-chosen' : 'gradient-primary-bg'}`}
        >
          <svg className="start-card__img" width="48" height="48" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
